...
none above 20%, and the float held in trust at a bank. That is not a startup-stage obstacle, it
...
**The deposit still solves what prepay was for.** BlaBlaCar's Poland launch, where the
contribution stayed in cash and only the fee went online, cut passenger no-shows by nearly 90%.
Requiring *some* payment is what changes behaviour.
